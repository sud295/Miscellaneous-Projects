...
public class Part1{
    ...
    public static void main(String[] args){
        ...
        String[] animalFile = {"cat", "dog", "bear", "llama", "moose", "lion", "cheetah", "cougar", "falcon", "human"};

        try{
            Scanner guessWord = new Scanner(System.in); // Scanner object to interact with user

            String word = animalFile[((int) (Math.random()*10))]; // Selecting a random word from the array
